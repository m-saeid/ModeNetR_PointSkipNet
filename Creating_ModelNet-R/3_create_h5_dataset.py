...
ds = "../data/modelnetR_normal_resampled"

n_points = 2048
newpath = f'../data/modelnetR_ply_hdf5_{n_points}' 
...
for mode in ['train', 'test']:
    ...
    for i in tqdm(range(len(paths)), desc = f'{mode}_data'):
        ...
        if len(data) == 2048 or (mode=='train' and r==4 and len(paths)==i+1) or (mode=='test' and r==1 and len(paths)==i+1):
            ...
            with h5py.File(f'../data/modelnetR_ply_hdf5_{n_points}/ply_data_{mode}{r}.h5', 'w') as f:
