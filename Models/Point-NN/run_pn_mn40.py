...
def parse_args():
    ...
    parser.add_argument('--batch_size', type=int, default=28, help='batch size in training')
...
def validate(net, testloader, criterion, eps, device):
    ...
    #plt.savefig('/home/iris/Desktop/Saeid_2080/cm/point-pn.png', bbox_inches='tight')
    #plt.show()
